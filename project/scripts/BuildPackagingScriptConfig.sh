...
echo "ProvisioningProfile=\"$PROVISIONING_PROFILE_DIR/$TARGET_NAME-$CONFIGURATION.mobileprovision\"" >> $OUTPUT
echo "DSYMDir=\"$DWARF_DSYM_FOLDER_PATH\"" >> $OUTPUT 
echo "DSYMFile=\"$DWARF_DSYM_FILE_NAME\"" >> $OUTPUT
